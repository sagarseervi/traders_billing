...
class TableFieldSearch extends StatefulWidget {
  ...
  @override
  _TableFieldSearchState createState() => _TableFieldSearchState();
}

class _TableFieldSearchState extends State<TableFieldSearch> {
