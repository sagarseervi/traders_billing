...
class SBGangTable extends StatefulWidget {
  @override
  _SBGangTableState createState() => _SBGangTableState();
}

class _SBGangTableState extends State<SBGangTable> {
  @override
        ...
        child: Column(
          children: [
            Table(
              ...
              children: [
                TableRow(children: [
                  TableCell(child: SBPageHeader(text: 'Gang Bill ID')),
