...
class SBBuyerTable extends StatefulWidget {
  @override
  _SBBuyerTableState createState() => _SBBuyerTableState();
}

class _SBBuyerTableState extends State<SBBuyerTable> {
  @override
        ...
        child: Column(
          children: [
            Table(
              ...
              children: [
                TableRow(children: [
                  TableCell(child: SBPageHeader(text: 'Buyer Bill ID')),
