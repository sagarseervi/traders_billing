...
class BuyerTable extends StatefulWidget {
  BuyerTable({Key key}) : super(key: key);

  @override
  _BuyerTableState createState() => _BuyerTableState();
}
      ...
      child: Column(
        children: [
          Table(
            children: [
              TableRow(children: [
                TableCell(child: ProfileTableHeaders(text: 'Buyer ID')),
                TableCell(child: ProfileTableHeaders(text: 'Buyer Name')),
